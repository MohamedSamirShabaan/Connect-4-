...
char arr[100][100];
char arrSaveAction[100]= {0}; //use to save each player action
char arrRestorePlace[100]= {0}; //use to restore the undo moving to restore it if no player playing any play

int Width , Height , Highscores , numberOfPlay , savePlace , numberOfCol ;// use in program as a global variables
char playerInput[20]  , whichPlayer ;
int restorePlace = 0 , scoreOne = 0 , scoreTwo = 0 , gameOut = 0;
int HighScoreList[50]= {0} , listLength = 0;

//begin arrInitialization function
void arrInitialization(int Height , int Width) // this function use to gave initial value to char array
{
    int counter1 , counter2 ; //use as a counter
...
// begin print array value in each change
void PrintArrayValue(int Height , int Width) // to print the board in screen with the value of array elements
{
    int counter1 , counter2 ; //use as a counter
    int flag = 0;
...
void player (char numberOfcol , int numberOfPlay);// function prototype
void computerPlayer();

void playAgain()//  to play again if the player enter the wrong move or wrong input
{
...
//begin computer function
void computerPlayer()
{
    int row , randomPlay ; // use to specifies the row
    int flag = 0; // use as break(get out from program when the condition ascertains
...
//begin player function
void player(char numberOfCol , int numberOfPlay) //use to save the player play
{
    int row; // use to specifies the row
    int flag = 0 , counter ; // use as break(get out from program when the condition ascertains
    int convert;
